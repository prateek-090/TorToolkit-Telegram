try:
    ...
    class ExecVars:
        ...
        API_HASH = "2dc9a997317b0ff7a2d84d5a1bd7f91b"
        API_ID = 7068279
        BOT_TOKEN = "1951563576:AAEySnTD4xMgkL_ZGhGztZVLII4GY8FY40U"
        BASE_URL_OF_BOT = "http://t.me/MANGEKYOSARINGAN_bot"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [1690773526,-1001292710628,1774616189]
        OWNER_ID = 1690773526
